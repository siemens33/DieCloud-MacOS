...
10. Helper-команды живут в `scripts/` (4 `.command` файла), в корне их нет. Ссылки: `package-dmg.sh` берёт Первый запуск из `scripts/` с fallback на корень, CI chmod чинит `scripts/*.command`.
